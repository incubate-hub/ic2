...
You can also find the full environment in the requirements.txt file under the root directory. You can clone a virtual conda environment using the following command (change myenv to desired environment name):
